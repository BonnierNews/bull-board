...
const JobCard = ({ job, status, actions, readOnlyMode, }) => (react_1.default.createElement("div", { className: JobCard_module_css_1.default.card },
        ...
        react_1.default.createElement("div", { className: JobCard_module_css_1.default.title },
            react_1.default.createElement("h4", null,
                ...
                job.attempts > 0 && react_1.default.createElement("span", null,
                    "attempt #",
                    job.attempts + 1)),
            !readOnlyMode && react_1.default.createElement(JobActions_1.JobActions, { status: status, actions: actions })),
