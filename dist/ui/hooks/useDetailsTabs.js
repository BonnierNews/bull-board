    ...
    return {
        ...
        getTabContent: ({ data, returnValue, opts, failedReason, stacktrace, }) => {
            switch (selectedTab) {
                ...
                case 'Error':
                    return (react_1.default.createElement(react_1.default.Fragment, null, stacktrace.length === 0 ? (react_1.default.createElement("div", { className: "error" }, !!failedReason ? failedReason : 'NA')) : (react_1.default.createElement(Highlight_1.Highlight, { language: "stacktrace", key: "stacktrace" }, stacktrace))));
                default:
                    return null;
            }
        },
